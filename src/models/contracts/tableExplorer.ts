...
//#region edit/getReferencedTables

export namespace EditGetReferencedTablesRequest {
    export const type = new RequestType<
        tableExplorer.EditGetReferencedTablesParams,
        tableExplorer.EditGetReferencedTablesResult,
        void,
        void
    >("edit/getReferencedTables");
}
